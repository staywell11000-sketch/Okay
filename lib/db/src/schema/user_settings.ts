...
export const userSettings = pgTable(
  "user_settings",
  {
    ...
    notifFrequency: varchar("notif_frequency", { length: 20 }).default("instant"),
    notifCategories: text("notif_categories"),
    emailNotifEnabled: boolean("email_notif_enabled").notNull().default(true),
